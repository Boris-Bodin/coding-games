...
/**
 * Co-authored by Orestis Melkonian & Nikos Filippakis, CERN colleagues.
 *
 * A more properly-structured and tested framework can be viewed at our
 * github repository: https://github.com/omelkonian/nintendo-crypto
 **/
